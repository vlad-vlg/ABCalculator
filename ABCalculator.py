...
def popup_window(n1, c1, n2, c2):
    ...
    lblConfidence = tk.Label(window, text='Уровень\nуверенности:',
                    font=('Helvetica', 16, 'bold'),
                    fg='#0000cc')
    lblConfidence.place(x=25, y=25)
    
    lblComment_90 = tk.Label(window, text='90%',
                    font=('Helvetica', 12, 'bold'),
                    justify='center',
                    fg='#0000cc')
    lblComment_90.place(x=200, y=25, width=80, height=30)
    
    if confidence_90:
        lblResult_90 = tk.Label(window, text='ДА',
                    font=('Helvetica', 12, 'bold'),
                    justify='center',
                    bg='#ccffcc',
                    fg='#008800',
                    relief='ridge')
        lblResult_90.place(x=200, y=55, width=80, height=30)
    else:
        lblResult_90 = tk.Label(window, text='НЕТ',
                    font=('Helvetica', 12, 'bold'),
                    justify='center',
                    bg='#ffcccc',
                    fg='#ff0000',
    ...
    lblComment_95 = tk.Label(window, text='95%',
                    font=('Helvetica', 12, 'bold'),
                    justify='center',
                    fg='#0000cc')
    lblComment_95.place(x=290, y=25, width=80, height=30)
    
    if confidence_95:
        lblResult_95 = tk.Label(window, text='ДА',
                    font=('Helvetica', 12, 'bold'),
                    justify='center',
                    bg='#ccffcc',
                    fg='#008800',
                    relief='ridge')
        lblResult_95.place(x=290, y=55, width=80, height=30)
    else:
        lblResult_95 = tk.Label(window, text='НЕТ',
                    font=('Helvetica', 12, 'bold'),
                    justify='center',
                    bg='#ffcccc',
                    fg='#ff0000',
    ...
    lblComment_99 = tk.Label(window, text='99%',
                    font=('Helvetica', 12, 'bold'),
                    justify='center',
                    fg='#0000cc')
    lblComment_99.place(x=380, y=25, width=80, height=30)
    
    if confidence_99:
        lblResult_99 = tk.Label(window, text='ДА',
                    font=('Helvetica', 12, 'bold'),
                    justify='center',
                    bg='#ccffcc',
                    fg='#008800',
                    relief='ridge')
        lblResult_99.place(x=380, y=55, width=80, height=30)
    else:
        lblResult_99 = tk.Label(window, text='НЕТ',
                    font=('Helvetica', 12, 'bold'),
                    justify='center',
                    bg='#ffcccc',
                    fg='#ff0000',
    ...
    btnClosePopup.place(x=210, y=450, width=80, height=30)
...
lblVisitors2 = tk.Label(root, text='Посетители:',
                font=('Helvetica', 10, 'bold'))
